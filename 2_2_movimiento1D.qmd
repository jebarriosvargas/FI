...
La distancia recorrida desde un tiempo inicial, $t_i$, a un tiempo final, $t_f$, es
$$
s = \int_{t_i}^{t_f} |v_{x}| dt
$$
:::
...
$$
a_x\iprn t_f \fprn = a_x \iprn t_i \fprn = 0\,{\rm m/s^2}
$$

$$
v_x \iprn t_f \fprn = v_x \iprn t_i \fprn =\text{constante}
